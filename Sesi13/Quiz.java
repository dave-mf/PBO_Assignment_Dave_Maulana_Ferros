...
public class Quiz extends JFrame implements ActionListener {
    ...
    public void setRandom(){
        ...
        JTextField inputplus = new JTextField();
        inputplus.setText(plus);
        dsp.add(inputplus);
        inputplus.setPreferredSize(new Dimension(20, 50));
        inputplus.setEditable(false);
